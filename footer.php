...
<footer id="footer">
  <div class="footer_cen">
    ...
    <div class="text_footer i_line"><?php _e('Факультет електроніки та інформаційних технологій', 'sumdu'); ?></div>
    <div class="i_line"><img class="logo3" src="<?php echo get_template_directory_uri() ?>/images/logo.png"/></div>
    <div class="text_footer i_line"><?php _e('Сумський Державний Університет', 'sumdu'); ?></div>
  </div>
</footer>
<?php wp_footer(); ?>
</body>
